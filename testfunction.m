function [fseg] = testfunction(MU,NU,a,Ec,rn,links,sigext,linkid,mobility,dopartials,stackforcevec,doinclusion,inclusion_pos_rad,doSFT,SFT_plane,doshielding,SurfacePlane,dobox,boxD)
...
%    t=etime(clock,t0); disp(sprintf('CalcLatticeForceNew time = %6.2f seconds\n',t));
    ...
    %fseg=[fpk, fpk]*0.5+[fr0, fr1]+[fs0, fs1]; %UNCOMMENT TO HAVE WORKING
    %PROPERLY
