...
for i=1:7
    ...
    filename = sprintf('Stress_Strain_curves/Stress_Strain_curve_r%02.0f_length%03.0f_100_screw.txt',radius,le(i));
    videoname = sprintf('Stress_Strain_curves/dislocation_r%02.0f_length%03.0f_100_screw.avi',radius,le(i));
