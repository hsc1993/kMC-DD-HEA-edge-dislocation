...
for radius=3:2:13
    for i=1:1
        ...
        filename = sprintf('Stress_Strain_curves/Stress_Strain_curve_r%02.0f_length%03.0f_100_edge_dist10+R_ppt.txt',radius,le(i));
        videoname = sprintf('Stress_Strain_curves/dislocation_r%02.0f_length%03.0f_100_edge_dist10+R_ppt.avi',radius,le(i));
